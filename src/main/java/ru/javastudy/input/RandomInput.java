...
public class RandomInput implements InputStrategy {
    ...
    private static final String[] SYLLABLES = {
            "нан", "тат", "мир", "лор", "сен", "кар", "бел", "дим", "пол", "вер",
            "тан", "мар", "сол", "рам", "лек", "бор", "вин", "гат", "зон", "лик",
            "мек", "нор", "пан", "рак", "сам", "тор", "вал", "шер", "дим", "фир",
            "хан", "цер", "шал", "бар", "лам", "тек", "жар", "ков", "рис", "мол"
    };
