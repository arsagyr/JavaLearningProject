...
public class Person {
    ...
    public static class Builder {
         ...
         * При нарушении границ срабатывает "магнитный" год (1899) для сохранения стабильности системы.
         * и сбора невалидных данных по году в одном месте для возможного анализа
         */
        public Person.Builder year(int year) {
            if (year < 1900 || year > 2026) {
                System.err.println("\nГод " + year + " вне диапазона (1900 - 2026). Установлено: 1899.");
                this.year = 1899;
            } else {
                this.year = year;
            }
         ...
         * для каждого поля (1899, Фамилия_Unknown, Имя_Unknown).
         */
